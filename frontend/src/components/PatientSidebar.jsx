...
const PatientSidebar = () => {
  ...
  const menuItems = [
    { id: 'home', label: 'Home', path: '/patient' },
    { id: 'journal', label: 'Journal', path: '/patient/journal' },
    { id: 'history', label: 'History', path: '/patient/history' }
  ]
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ margin: '5px 0 0 0', fontSize: '0.9rem', opacity: 0.8 }}>Patient Portal</p>
      </div>
